...
/** \file
 *
 *  Header file for MozAvrAmmeter.c.
 */

#ifndef _MOZ_AVR_AMMETER_H_
#define _MOZ_AVR_AMMETER_H_
	...
	/* Macros: */
		...
		#define COMPENSATION_FLAG_LOCATION 11
		#define BASELINE_VOLTAGE_LOCATION 12
		#define LOGGING_FLAG_LOCATION 16
		
		#define AMMETER_VERSION 8 // actual version = AMMETER_VERSION / 10.0
